...
所有坑都不超過 4 格寬。跳躍高度 236 px（3.7 格）、跑速 280 px/s，滿跳
水平最遠約 5.1 格，留一格安全邊際。垂直落差改用移動平台解決，不用寬坑。
"""
...
ground(163, 175)
# 垂直平台是通往上層磚台的唯一路徑。上面有六枚金幣與一隻箭頭守著。
put(168, STAND - 3, "V")
bricks(171, 176, STAND - 5)
coins([171, 172, 173, 174, 175], STAND - 6)
put(173, STAND - 7, "a")
